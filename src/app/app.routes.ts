...
import { LearningFormComponent } from './components/learning-examples/learning-form/learning-form';
import { DashboardPageComponent } from './components/learning-examples/dashboard-page/dashboard-page';
...
export const routes: Routes = [
  ...
  // Component composition demo (public - for learning purposes)
  { path: 'component-demo', component: DashboardPageComponent },
